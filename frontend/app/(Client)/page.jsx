    ...
    <div style={{ marginTop: '50px', overflow: 'hidden', position: 'relative', display: 'flex', flexDirection: 'column' }}>
      <div className={styles.mainCont} style={{ position: 'relative', height: '500px', width: '100%', display: "flex", flexDirection: "column" }}>
        ...
        <h1 className={`middleAbsolute ${styles.mainTitle}`} style={{ color: '#175DE3', fontSize: '4rem', textAlign: 'center', textWrap: 'nowrap' }}>
          با  تیم     <HilightedTitle
            topSvgOffset={'40px'}
            topSvgLeftOffset={'20px'}
            bottomSvgOffset={'30px'}
            bottomSvgRightOffset={'30px'}
            fontSize={'8rem'} color={'#FEB020'}>ســـــایــمـــون</HilightedTitle><br></br>
      ...
      <section style={{ padding: ' 0px 30px' }} className={styles.sectionNeed}>
        <div className={styles.sectionNeed__Right}>
          ...
          >
            سایت، قلب دیجیتال برند شماست؛ ویترینی همیشگی برای دیده‌شدن، فروش بیشتر و اعتمادسازی. مشتریان امروز اول در گوگل جستجو می‌کنند، بعد خرید می کنند. بدون سایت، نادیده می‌مانید و رقبا جلو می‌زنند. سایتی حرفه‌ای، ۲۴ ساعته بدون تعطیلی، محصولات و خدماتتان را به نمایش می‌گذارد، مخاطبان هدفمند جذب می‌کند و فروش را چندبرابر افزایش می‌دهد. همچنین به‌راحتی می‌توانید برندتان را معتبرتر نشان دهید و مشتریان وفادار بسازید. تیم سایمون همراه شماست تا خانه‌ای دیجیتال بسازد که کسب‌وکارتان را به اوج برساند.          </p>
      ...
      <section className={styles.simonIntroduceSection}>
        <div dir="ltr" className={styles.simonIntroduceSection__SvgCont}>
          ...
          <div className={styles.simonIntroduceSection__paragraph} dir="rtl">
            ...
            <p className={styles.simonIntroduceSection__p}>تیم سایمون از دلی پر از امید و ذهنی سرشار از ایده زاده شد ؛ اینکه هر برندی، حتی در کوچک‌ترین ابعادش، شایسته‌ی درخششی بی‌نظیر در عرصه‌ی دیجیتال است. ما خانواده‌ای از متخصصان خلاق، برنامه‌نویسان هنرمند و مشاوران کارآزموده هستیم که در کنار یکدیگر گرد آمده‌ایم تا رویاهای برندها را به شکلی ملموس و باشکوه به واقعیت پیوند بزنیم. در اندیشه‌ی سایمون، سایت چیزی فراتر از کدهای خشک و قالب‌های تکراری است؛ بلکه خانه‌ای جان‌دار، نفس‌کشنده و سرشار از هویت است که با ظرافتی هنرمندانه، مهندسی‌ای دقیق و عشقی صمیمانه برایتان ساخته می‌شود. اینجا، هر گوشه‌ای از سایت، روایتی از شخصیت منحصربه‌فرد برند شماست و ما به جان و دل افتخار می‌کنیم که معمار این خانه‌ی دیجیتال هستیم.
            </p>
          </div>
        </div>
      ...
      <section className={styles.servicesSection}>
        ...
        <div className={styles.servicesSection__threeCont}>
          <p style={{ textAlign: 'justify' }}>ما در تیم سایمون، خدمات جامع و کاملی را برای حضور قدرتمند شما در فضای دیجیتال ارائه می‌دهیم. از طراحی سایت‌های اختصاصی، فروشگاهی و شرکتی گرفته تا اپلیکیشن‌های موبایل و سیستم‌های مدیریت محتوا، همه را با بالاترین استانداردهای روز دنیا پیاده‌سازی می‌کنیم. خدمات ما شامل طراحی رابط کاربری زیبا و کاربرپسند، بهینه‌سازی برای موتورهای جستجو، امنیت پیشرفته، پشتیبانی فنی دائمی و مشاوره‌ی استراتژیک برای رشد کسب‌وکارتان است. ما به کسب‌وکار شما به چشم یک پروژه نگاه نمی‌کنیم؛ بلکه آن را مانند یک همراهی بلندمدت می‌بینیم. تیم سایمون، از صفر تا اوج در کنار شماست تا برندتان را به قله‌های موفقیت دیجیتال برساند.</p>
        </div>
