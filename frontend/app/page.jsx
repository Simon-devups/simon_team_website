...
export default function Home() {
  return (
    <div style={{overflow: 'hidden' , position: 'relative' , display: 'flex' , flexDirection:'column'}}>
      <div style={{ position: 'relative', height: '500px', width: '100%', display: "flex", flexDirection: "column" }}>
        ...
        <h1 className="middleAbsolute" style={{ color: '#175DE3', fontSize: '4rem', textAlign: 'center' }}>
  ...
  <div className={styles.sectionNeed__Left}>
    <svg width="100%" height="696" viewBox="0 0 696 696" fill="none" xmlns="http://www.w3.org/2000/svg">
